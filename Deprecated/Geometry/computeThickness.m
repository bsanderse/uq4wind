function  samplesThickness = computeThickness(samples,randVec, pc, plotSamples,bladeLength,...
...
samplesThickness = perturbNURBS(t0,n,interpolationLocations,c, pc,samples,randVec);
