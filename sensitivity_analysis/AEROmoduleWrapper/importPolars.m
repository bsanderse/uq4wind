function [alpha, Cl, Cd, Cm, header] = importPolars(filename, dataLines)
...
all_lines = textscan(fid_in,'%s','delimiter','\n');
all_lines = all_lines{1};
header    = all_lines(1:n_header);
