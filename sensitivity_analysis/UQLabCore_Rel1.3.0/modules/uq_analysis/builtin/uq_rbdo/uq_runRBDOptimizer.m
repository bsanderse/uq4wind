...
if any(strcmpi(current_analysis.Internal.Optim.Method,{'ip','sqp','hccmaes','hga'}))
...
%         output = rmfield(output,{'History'}) ;
    ...
    case 'intccmaes'
        ...
        optim_options.Enrichment.Restart = current_analysis.Internal.Constraints.Enrichment.LocalRestart ;
