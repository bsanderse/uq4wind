function [Data,Conj,InputDist,ForwardModel,DiscrepancyOpt] = uq_inversion_test_MCMC_setup
% UQ_INVERSION_TEST_MCMC_SETUP sets up a simple MCMC test problem with 1D
%   Gaussian conjugate priors. This is used in many selftests of the
%   inversion module.
