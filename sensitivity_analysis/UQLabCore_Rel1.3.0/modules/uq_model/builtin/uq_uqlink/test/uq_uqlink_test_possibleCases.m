...
delete(fullfile(Mopts.ExecutionPath,'BeamBasicCase.mat')) ;
...
myModel = uq_createModel(Mopts) ;
Yval = uq_evalModel(myModel,X);
delete(fullfile(Mopts.ExecutionPath,'Beam_v2.mat')) ;
pass = pass && max(abs(Ytrue-Yval))< eps_th;
...
myModel = uq_createModel(Mopts) ;
Yval = uq_evalModel(myModel,X);
delete(fullfile(Mopts.ExecutionPath,'Beam_v3.mat')) ;
pass = pass && max(abs(Ytrue-Yval))< eps_th;
...
myModel = uq_createModel(Mopts) ;
Yval = uq_evalModel(myModel,X);
delete(fullfile(Mopts.ExecutionPath,'Beam_v4.mat')) ;
pass = pass && max(abs(Ytrue-Yval))< eps_th;
...
myModel = uq_createModel(Mopts) ;
Yval = uq_evalModel(myModel,X);
delete(fullfile(Mopts.ExecutionPath,'BeamTestExecutableOption.mat')) ;
