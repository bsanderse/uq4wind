...
fprintf(['\nRunning: |' level '| uq_inversion_test_MCMC_MH_custProp...\n']);
%% PROBLEM SETUP
[y,Conj,PriorDist,ForwardModel,DiscrepancyOpt] = uq_inversion_test_MCMC_setup;
...
KLDiv = uq_inversion_test_MCMC_computeKL(BayesianAnalysis,Conj);
