...
% was $N = 90{,}000$ compared to the $N = 50$ model evaluations necessary
...
%
% In this example, a PCE surrogate was used, but generally any surrogate
% model available in UQLab (e.g., Kriging, LRA, SVR) can be used.