function  samplesChord = computeChord(samples,randVec, pc, plotSamples,bladeLength,...
...
if nargin < 5 % Default function argument values corresponding to NM80 turbine
    ...
    %pc = 0.1*ones(numel(sampledLocations),1); % This will lead to plus minus 5% of uncertainty in chord curve
end
