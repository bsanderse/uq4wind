...
switch lower(module)
    ...
    case 'pce'
        ...
        disp([tabchar, 'Report UQLab-V1.2-104, Chair of Risk, Safety & Uncertainty Quantification, ']);
        disp([tabchar, 'ETH Zurich, 2019.']);
        fprintf('\n');
    case 'kriging'
        disp('To cite the Kriging manual in publications please use:');
        fprintf('\n');
        disp([tabchar, 'C. Lataniotis, S. Marelli and B. Sudret, UQLab user manual - Kriging (Gaussian process modelling),']);
        disp([tabchar, 'Report UQLab-V1.2-105, Chair of Risk, Safety & Uncertainty Quantification']);
        disp([tabchar, 'ETH Zurich, 2019.']);
        fprintf('\n');
    case 'sensitivity'
        ...
        disp([tabchar, 'Report UQLab-V1.2-106, Chair of Risk, Safety & Uncertainty Quantification,']);
        disp([tabchar, 'ETH Zurich, 2019.']);
        fprintf('\n');
    case 'reliability'
        ...
        disp([tabchar, 'Report UQLab-V1.2-107, Chair of Risk, Safety & Uncertainty Quantification,']);
        disp([tabchar, 'ETH Zurich, 2019.']);
        fprintf('\n');
    case 'input'
        disp('To cite the Input manual in publications please use:');
        fprintf('\n');
        disp([tabchar, 'C. Lataniotis, S. Marelli and B. Sudret, UQLab user manual - The Input module,']);
        disp([tabchar, 'Report UQLab-V1.2-102, Chair of Risk, Safety & Uncertainty Quantification,']);
        disp([tabchar, 'ETH Zurich, 2019.']);
        fprintf('\n');
    ...
    case 'inversion'
        ...
        disp([tabchar, 'Report UQLab-V1.2-113, Chair of Risk, Safety & Uncertainty Quantification,']);
        disp([tabchar, 'ETH Zurich, 2019.']);
        fprintf('\n');
    ...
    case 'model'
        ...
        disp([tabchar, 'Report UQLab-V1.2-103, Chair of Risk, Safety & Uncertainty Quantification,']);
        disp([tabchar, 'ETH Zurich, 2019.']);
        fprintf('\n');
    ...
    case 'lra'
        ...
        disp([tabchar, 'Report UQLab-V1.2-108, Chair of Risk, Safety & Uncertainty Quantification,']);
        disp([tabchar, 'ETH Zurich, 2019.']);
        fprintf('\n');
    ...
    case 'pck'
        ...
        disp([tabchar, 'Report UQLab-V1.2-109, Chair of Risk, Safety & Uncertainty Quantification,']);
        disp([tabchar, 'ETH Zurich, 2019.']);
        fprintf('\n');
    ...
    case 'svr'
        ...
        disp([tabchar, 'Report UQLab-V1.2-111, Chair of Risk, Safety & Uncertainty Quantification,']);
        disp([tabchar, 'ETH Zurich, 2019.']);
        fprintf('\n');
    ...
    case 'svc'
        ...
        disp([tabchar, 'Report UQLab-V1.2-112, Chair of Risk, Safety & Uncertainty Quantification,']);
        disp([tabchar, 'ETH Zurich, 2019.']);
        fprintf('\n');
    ...
    case 'uqlink'
        ...
        disp([tabchar, 'Report UQLab-V1.2-110, Chair of Risk, Safety & Uncertainty Quantification,']);
        disp([tabchar, 'ETH Zurich, 2019.']);
        fprintf('\n');
