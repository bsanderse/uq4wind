...
switch M
    case 1
        ...
        for ii = 1:length(outArray)
            ...
            current_output = outArray(ii);
            uq_figure('name',...
                sprintf('Output #%i', current_output),...
            ...
            h1 = plot(Xtrain(nIsv,:), Ytrain(nIsv,current_output),...
                'ko', 'MarkerFaceColor', 'k');
            % Plot support vectors
            h2 = plot(Xtrain(Isv,:), Ytrain(Isv,current_output),...
                'kd', 'MarkerFaceColor', 'g');
            if isempty(h1)
            ...
            grid on
            % Put legend
            leg = uq_legend(legendHandles, legendTxt,...
    ...
    case 2
        for ii = 1:length(outArray)
            ...
            h1 = plot(Xtrain(~Isv,1), Xtrain(~Isv,2),...
                'ko', 'MarkerFaceColor', 'r', 'MarkerEdgeColor', 'none');
            h2 = plot(Xtrain(Isv,1), Xtrain(Isv,2),...
