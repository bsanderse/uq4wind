...
%     (PDF) of samples of a random vector collected in X matrix. Each 
%     column of X corresponds to a component of the random vector that 
...
%
% See also UQ_ALL_CDF, UQ_ALL_INVCDF, UQ_EVAL_PDF
pdfx = zeros(size(X));
