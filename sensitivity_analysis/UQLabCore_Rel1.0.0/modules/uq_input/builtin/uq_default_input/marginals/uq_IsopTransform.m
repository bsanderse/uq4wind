...
%     structure arrays X_marginals and Y_marginals. In this function the 
%     components of X and Y are assumed to be independent. 
%
%     For performing isoprobabilistic transformation of random vectors with
%     dependent components check uq_GeneralIsopTransform
%
% See also UQ_GENERALISOPTRANSFORM

% Check whether X and Y have the same marginal distributions. First check
% only the first element to avaid the full comparison if they are different
