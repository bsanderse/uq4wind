...
if ~CUSTOM_LIKELI
    ...
    MModel_nonConst = numel(module.Internal.ConstInfo.idNonConst)- MDiscrepancy;
    MModel_Const = numel(module.Internal.ConstInfo.idConst);
...
if MCMC_flag
    ...
    if pointEstimate_avail
        ...
        if percentiles_avail
            ...
            TStr(1,:) = {'Parameter', 'Mean', 'Std',sprintf('(%.2g-%.2g) quantiles',probabilities(1),probabilities(end)),'Parameter Type'};
