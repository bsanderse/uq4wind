...
%% Display the MONTE CARLO, SUBSET SIMULATION, AK-MCS or IMPORTANCE SAMPLING results
if strcmp(module.Internal.Method, 'mc') || strcmp(module.Internal.Method, 'is')...
    ...
    curline1 = [curline1, '['];
    curline1 = sprintf('%s%-12.4d',curline1,Results.PfCI(oo,:));
    curline1 = [curline1, ']'];
    fprintf([curline1, '\n'])
    ...
    curline1 = [curline1, '['];
    curline1 = sprintf('%s%-12.4d',curline1,Results.BetaCI(oo,:));
    curline1 = [curline1, ']'];
    fprintf([curline1, '\n'])
...
if strcmpi(module.Internal.Method, 'akmcs')
    ...
    curline1 = [curline1, '['];
    curline1 = sprintf('%s%-12.4d',curline1,[Results.History(oo).PfLower(end) Results.History(oo).PfUpper(end)]);
    curline1 = [curline1, ']'];
    fprintf([curline1, '\n'])
    ...
    if strcmp(module.Internal.Method, 'sorm') || strcmp(module.Internal.Method, 'form')
