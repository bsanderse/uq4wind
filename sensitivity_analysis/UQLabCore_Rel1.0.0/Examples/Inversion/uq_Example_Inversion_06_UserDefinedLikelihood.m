...
% |uq_Example_customLogLikelihood.m|), makes
...
% Create a function handle to the function |uq_Example_customLogLikelihood|
% as a wrapper with the two arguments:
myLogLikelihood = @(params,y) uq_Example_customLogLikelihood(params,...
    y, ModelSetup);
...
% using $100$ parallel chains, each with $500$ iterations:
Solver.Type = 'MCMC';
...
BayesOpt.LogLikelihood = myLogLikelihood;
...
%% 5.3 Posterior sample post-processing
%
...
% |uq_Example_customLogLikelihood.m|.
%
