...
% update the plots every $100$ iterations:
...
% In UQLab, this can be done with the |uq_inversion_postProc| function:
myBayesianAnalysis = uq_postProcessInversion(myBayesianAnalysis,...
                     'burnIn', 0.33,...
                     'posteriorPredictive', 1000);

%%
% The command removes the first third sample points and then samples 
