...
% algorithm is chosen, with $700$ iterations and $100$ parallel chains:
Solver.Type = 'MCMC';
...
% Update the plots every $50$ iterations:
...
%%
% *Note*: sampling prior- and posterior- predictive samples requires new
% model evaluations
