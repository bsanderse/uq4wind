...
%% 4 - POLYNOMIAL CHAOS EXPANSION METAMODELS
%
...
for ii = 1:size(Yval,1)
    uq_plot(li, [0,Yval(ii,:),0], 'LineWidth', 2, 'Color', myColors(ii,:))
    uq_plot(li, [0,Y_PC_LARS(ii,:),0],...
        '--o', 'LineWidth', 2, 'MarkerSize', 2, 'Color', myColors(ii,:))
    uq_plot(li, [0,Y_PC_OMP(ii,:),0],...
