...
%
% Select the LRA metamodeling technique:
...
%%
% The rank and degree combination with the lowest 3-fold CV error
% are chosen for the final metamodel.
% Specify this adapatation strategy (rank and degree adaptation):
MetaOpts.Adaptivity = 'adapt_r_d';

%%
% For more reliable cross-validation results,
% increase the number of partitions (the default is 3-fold):
...
uq_figure('Position', [50 50 500 400])
myColors = uq_cmap(Nval); % use the UQLab colormap
