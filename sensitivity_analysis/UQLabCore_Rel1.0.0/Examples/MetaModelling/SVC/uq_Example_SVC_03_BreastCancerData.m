...
% for Classification (SVC) metamodeling on the breast 
% cancer Wisconsin (diagnostic) data set.
%
% For more information, see: Street, W.N., W.H. Wolberg, and
% O.L. Mangasarian. (1993). Nuclear feature extraction for breast tumor 
% diagnosis. IS&T/SPIE 1993 International Symposium on Electronic Imaging: 
% Science and Technology (1905), 861-870. 
...
uq_plot(cutOffVals,accVals)
hold on
uq_plot(cutOffVals,falsePosVals);
uq_plot(cutOffVals,falseNegVals);
hold off
grid on
legend({'Accuracy', 'False positives', 'False negatives'},...
