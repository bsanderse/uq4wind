...
% Matérn 5/2, and custom (mixture of Gaussian and second-order polynomial
% kernels).
...
% and length and stored in the variable |X|.
...
% The data set contains of $100$ points.

%% 3 - SVC METAMODELS
%
% Select the SVC metamodeling tool:
MetaOpts.Type = 'Metamodel';
MetaOpts.MetaType = 'SVC';

%% 
% Assign the data set loaded above:
...
%%
% Use the cross-entropy method for optimization:
...
% (plotting only available for functions up to 2D):
uq_display(mySVC_gau)

%% 3.2 Linear kernel
%
% Create another SVC metamodel using a linear kernel:
...
%
% A user-defined (custom) kernel is built up as a mixture of Gaussian
...
%%
% Set bounds on the search space for the hyperparameters calibration and 
