...
%
% To compare different PC-Kriging metamodeling techniques, create a single 
...
display(['Prediction mean value: ', num2str(ySPCK)])
display(['Prediction variance: ', num2str(ySPCKs2)])
