...
% using the eight-dimensional Ishigami function 
...
%%
% Use the Gaussian correlation family for the Gaussian process model in 
% the PC-Kriging metamodel:
...
% Use all the previous metamodeling options and select Optimal PC-Kriging
% as the mode:
...
%% 7 - VALIDATION
%
% The accuracy of the two metamodels is compared
...
uq_figure('position', [50 50 650 500])
