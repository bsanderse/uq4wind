...
% * Roustant, O., D. Ginsbourger, Y. Deville. (2012). DiceKriging,
...
%   Software 51(1). <https://doi.org/10.18637/jss.v051.i01 DOI:10.18637/jss.v051.i01>
...
% produce a scatter plot of the Kriging predictions (the mean)
% vs. the true responses on the validation set:
uq_figure('Position', [50 50 500 400])
myColors = uq_cmap(2);

uq_plot(Yval, YKRGmean, '+', 'Color', myColors(1,:))
hold on
