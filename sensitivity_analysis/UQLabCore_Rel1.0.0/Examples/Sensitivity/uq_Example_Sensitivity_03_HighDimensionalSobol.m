...
% 
% *Note*: This example runs a very high-dimensional analysis, it can
% take up between 2 to 3 minutes to complete.
...
% 
% When all the input variables are identically distributed,
% the sensitivity pattern of this function has an overall 
% non-linearly increasing trend with the variable number.
% In addition, it presents distinct peaks for
% variables $x_1$, $x_5$, $x_{50}$, and $x_{54}$.
% Finally, four 2-term interaction peaks are expected: 
% $x_1 x_2$, $x_2 x_4$, $x_3 x_5$, and $x_{50} x_{54}$. 
% By construction, each pair of interaction terms
...
%
% Due to the dimensionality of the model,
% Sobol' indices are directly calculated with polynomial chaos expansion
% (PCE).
...
%%
% Specify the PCE truncation parameters:
PCEOpts.TruncOptions.qNorm = 0.7;
PCEOpts.TruncOptions.MaxInteraction = 2;

%%
% Specify an experimental design of size $1200$
