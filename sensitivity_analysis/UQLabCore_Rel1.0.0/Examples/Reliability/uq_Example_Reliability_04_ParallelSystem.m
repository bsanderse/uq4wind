...
% $$
%
% Specify probabilistic model for the two input random variables:
...
%
% Specify the Reliability module and the Monte Carlo simulation (MCS)
% method:
...
MCSOptions.Simulation.MaxSampleSize = 2e6;
...
%% 4.2 FORM
%
% Specify the Reliability module and the FORM method:
