...
% connected by springs and dampers, as described in:
% Dubourg et al. (2013). "Metamodel-based importance sampling for structural
% reliability analysis," Prob. Eng. Mech. (33), pp. 47-57.
...
% by the function |uq_DampeOscillator(X)| supplied with UQLab.
...
%% 
% Define a MODEL object using the function:
...
% as well as the description for each variable.
...
MCSOptions.Simulation.BatchSize = 1e4;
MCSOptions.Simulation.MaxSampleSize = 1e7;
...
SSimOptions.Simulation.BatchSize = 1e4;
...
%%
% Specify the sample size and the target coefficient of variation (CoV):
ISOptions.Simulation.BatchSize = 1e4;
ISOptions.Simulation.MaxSampleSize = 1e7;
ISOptions.Simulation.TargetCoV = 1e-2;

%%
% Save the evaluations:
ISOptions.SaveEvaluations = 1;
