...
% for PCE-OLS:
NsamplesOLS = [5 10 20]; % if not specified, the number of samples from Quad is taken
OLS_repeat = 1; % like MC_repeat

% % for PCE-LARS:
NsamplesLARS = [5 10 20]; % if not specified, the number of samples from Quad is taken
