...
Input.Marginals(counter).Parameters = AM12;% [AM12 AM12_Std];
...
Input.Marginals(counter).Type = 'Constant'; 
Input.Marginals(counter).Parameters = AM13; %[AM13, AM13_Std*abs(AM13)];
...
Input.Marginals(counter).Type = 'Constant'; 
Input.Marginals(counter).Parameters = AM14; %[AM14, AM14_Std*abs(AM14)];
...
Input.Marginals(counter).Type = 'Constant'; 
Input.Marginals(counter).Parameters = AM15;% [AM15, AM15_Std*abs(AM15)];
% Input.Marginals(counter).Bounds = [AM14_LB AM14_UB]; 
...
Input.Marginals(counter).Type = 'Constant'; 
Input.Marginals(counter).Parameters = AM21; %[AM21, AM21_Std*abs(AM21)];
% Input.Marginals(counter).Bounds = [AM11_LB AM11_UB]; 
...
Input.Marginals(counter).Type = 'Constant'; 
Input.Marginals(counter).Parameters = AM22; %[AM22, AM22_Std*abs(AM22)];
% Input.Marginals(counter).Bounds = [AM12_LB AM12_UB]; 
...
Input.Marginals(counter).Type = 'Constant'; 
Input.Marginals(counter).Parameters = AM23; %[AM23, AM23_Std*abs(AM23)];
% Input.Marginals(counter).Bounds = [AM13_LB AM13_UB]; 
...
Input.Marginals(counter).Type = 'Constant'; 
Input.Marginals(counter).Parameters = AM24; %[AM24, AM24_Std*abs(AM24)];
% Input.Marginals(counter).Bounds = [AM14_LB AM14_UB]; 
...
Input.Marginals(counter).Type = 'Constant'; 
Input.Marginals(counter).Parameters = AM25; %[AM25, AM25_Std*abs(AM25)];
% Input.Marginals(counter).Bounds = [AM14_LB AM14_UB]; 
...
Input.Marginals(counter).Type = 'Constant'; 
Input.Marginals(counter).Parameters = PH11; %[PH11, PH11_Std];
...
Input.Marginals(counter).Type = 'Constant'; 
Input.Marginals(counter).Parameters = PH12; %[PH12, PH12_Std];
...
Input.Marginals(counter).Type = 'Constant'; 
Input.Marginals(counter).Parameters = PH13; %[PH13, PH13_Std];
...
Input.Marginals(counter).Type = 'Constant'; 
Input.Marginals(counter).Parameters = PH14; %[PH14, PH14_Std];
...
Input.Marginals(counter).Type = 'Constant'; 
Input.Marginals(counter).Parameters = PH15; %[PH15, PH15_Std];
%Input.Marginals(counter).Bounds = [PH14_LB PH14_UB]; 
...
Input.Marginals(counter).Type = 'Constant'; 
Input.Marginals(counter).Parameters = PH21; %[PH21, PH21_Std];
% Input.Marginals(counter).Bounds = [PH11_LB PH11_UB]; 
...
Input.Marginals(counter).Type = 'Constant'; 
Input.Marginals(counter).Parameters = PH22; %[PH22, PH22_Std];
% Input.Marginals(counter).Bounds = [PH12_LB PH12_UB]; 
...
Input.Marginals(counter).Type = 'Constant'; 
Input.Marginals(counter).Parameters = PH23; %[PH23, PH23_Std];
% Input.Marginals(counter).Bounds = [PH13_LB PH13_UB]; 
...
Input.Marginals(counter).Type = 'Constant'; 
Input.Marginals(counter).Parameters = PH24; %[PH24, PH24_Std];
% Input.Marginals(counter).Bounds = [PH14_LB PH14_UB]; 
...
Input.Marginals(counter).Type = 'Constant'; 
Input.Marginals(counter).Parameters = PH25; %[PH25, PH25_Std];
% Input.Marginals(counter).Bounds = [PH14_LB PH14_UB]; 
